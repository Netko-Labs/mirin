...
pub use window::{
    ...
    discard_window, make_view_autoresizing, set_draggable_regions, set_traffic_light_position,
    set_window_title, window_id_for_view, DragRegion, TitleBarStyle, WindowParams,
};
