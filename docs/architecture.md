...
3. Resolve configuration, honor any active updater handoff reservation, and
   ...
   activation. Long identifiers use a deterministic bounded prefix/hash identity
   so Win32 class and AppUserModelID limits cannot prevent window creation, while
