...
Helper acceptance is a two-way barrier. The parent durably records the helper's
PID and OS creation identity in the launch reservation, then publishes an
