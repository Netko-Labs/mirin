...
x64: `libmirin_core.so` (the CEF browser-process core, `dlopen`ed by the host),
`mirin-codec` (the atomic updater swap and release codec), and `mirin-helper` (the CEF subprocess).
